...
public class JwtService {
  ...
  public JwtService() {
    ...
    secretKey = dotenv.get("MY_SECRET_KEY");
    jwtExpiration = Long.valueOf(dotenv.get("JWT_EXPIRATION"));
    refreshExpiration = Long.valueOf(dotenv.get("JWT_REFRESH_EXPIRATION"));
  }
  ...
  private Key getSignInKey() {
    ...
    String str = new String(Decoders.BASE64.decode(secretKey));
